...
<div class="col-md-2 sidebar p-0">
    ...
    <div class="nav-menu">
        ...
        <a href="{{ route('registration.list', ['kelas' => 'PG'] + request()->except('page')) }}" class="{{ request()->routeIs('registration.*') ? 'active' : '' }}"><i class="fa-solid fa-users"></i> Data Pendaftar</a>
        <a href="{{ route('report.list', ['kelas' => 'PG'] + request()->except('page')) }}" class="{{ request()->routeIs('report.*') ? 'active' : '' }}"><i class="fa-solid fa-file"></i> Laporan</a>
